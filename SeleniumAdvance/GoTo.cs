...
namespace SeleniumAdvance
{
    public class GoTo
    {
        ...
        public void Demo()
        {
            ...
            driver.FindElement(By.XPath("//span[@class='flag-icon flag-icon-us mr-1']")).Click();
            driver.FindElement(By.XPath("//input[@id=\"autocomplete\"]")).SendKeys("Los Angeles");
            driver.FindElement(By.XPath("//input[@id='autocomplete2']")).SendKeys("Dallas");
            driver.FindElement(By.XPath("(//i[@class='la la-angle-down'])[3]")).Click();
